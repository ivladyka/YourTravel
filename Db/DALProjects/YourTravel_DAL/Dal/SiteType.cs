...
{
	public abstract class _SiteType : SqlClientEntity
	{
		public _SiteType()
		{
			this.QuerySource = "SiteType";
			this.MappingName = "SiteType";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadAllSiteType]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int SiteTypeID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.SiteTypeID, SiteTypeID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadSiteTypeByPrimaryKey]", parameters);
		}
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "InsertSiteType]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "UpdateSiteType]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "DeleteSiteType]";
