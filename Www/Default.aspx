...
<script language="javascript">
  ...
  <div class="slideshow">
		     <ul id="slider" style="overflow: hidden;">
			     <li class="slide">
					<img width="1060" height="460" class="slide-img" alt="" src="Images/1.jpg">
				...
				<li class="slide">
					 <img width="1060" height="460" class="slide-img" alt="" src="Images/3.jpg">
					<div class="sliding-image">   					   
					</div>
					<div class="sliding-text">
				...
				<li class="slide">
					 <img width="1060" height="460" class="slide-img" alt="" src="Images/5.jpg">
					 <div class="sliding-image"> 					
					 </div>
					 <div class="sliding-text">
				...
				<li class="slide">
					 <img width="1060" height="460" class="slide-img" alt="" src="Images/7.jpg">
					 <div class="sliding-image"> 					    
				     </div>
					 <div class="sliding-text">
