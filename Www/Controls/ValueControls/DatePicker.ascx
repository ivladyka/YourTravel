...
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
 <telerik:RadDatePicker id="dateInput" Runat="server" MaxDate="3000-01-01" 
    MinDate="1900-01-01" Skin="Office2007" EnableTyping="False" BorderStyle="Outset" CssClass="datapickerstyle">
                    <DateInput  Skin="Office2007" ReadOnly="True" ForeColor="black"></DateInput>
